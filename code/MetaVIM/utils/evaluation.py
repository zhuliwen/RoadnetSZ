...
def visualise_behaviour(args,
                        ...
                        compute_rew_reconstruction_loss_neighbor=None,
                        compute_state_reconstruction_loss_neighbor=None,
    ...
    if hasattr(unwrapped_env, 'visualise_behaviour'):
        ...
        traj = unwrapped_env.visualise_behaviour(env=env,
                                                 ...
                                                 reward_decoder_neighbor=reward_decoder_neighbor,
                                                 state_decoder_neighbor=state_decoder_neighbor,
    ...
    if latent_means is not None:
        ...
        if not (args.disable_stochasticity_in_latent and args.disable_decoder):
            plot_vae_loss(args,
                          ...
                          compute_rew_reconstruction_loss_neighbor=compute_rew_reconstruction_loss_neighbor,
                          compute_state_reconstrction_loss_neighbor=compute_state_reconstruction_loss_neighbor,
...
def plot_vae_loss(args,
                  ...
                  reward_decoder,
                  state_decoder,
                  reward_decoder_neighbor,
                  state_decoder_neighbor,
                  task_decoder,
                  compute_task_reconstruction_loss,
                  compute_rew_reconstruction_loss,
                  compute_state_reconstruction_loss,
                  compute_rew_reconstruction_loss_neighbor,
                  compute_state_reconstruction_loss_neighbor,
                  compute_kl_loss
                  ):
    num_rollouts = len(latent_means)
    num_episode_steps = len(latent_means[0])
