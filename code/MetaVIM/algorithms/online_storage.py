...
class OnlineStorage(object):
    def __init__(self, args, num_steps, num_processes, obs_shape, action_space,
        ...
        if action_space.__class__.__name__ == 'Discrete':
            ...
            action_shape = 2 # action_space.shape[0]
    ...
    def insert(self,
        ...
        rewards_raw = rewards_raw.reshape(list(rewards_raw.shape)[0], 1)
        rewards_normalised = rewards_normalised.reshape(list(rewards_normalised.shape)[0], 1)
