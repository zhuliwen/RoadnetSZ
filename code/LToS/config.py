...
from Swarm_CoLight_agent import SwarmCoLightAgent
...
DIC_EXP_CONF = {
    ...
    "LIST_MODEL_NEED_TO_UPDATE":
        ["Deeplight", "SimpleDQN", "CoLight","SwarmCoLight","GCN", "SimpleDQNOne","Lit"],
    "MODEL_POOL": False,
    "NUM_BEST_MODEL": 3,
    "PRETRAIN": True,
...
DIC_AGENTS = {
    ...
    'SwarmCoLight': SwarmCoLightAgent,
    # 'GCN': GCNAgent,
